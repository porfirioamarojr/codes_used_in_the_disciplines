...
void * consumer(){
    ...
    while(i != PROD_NUM){
        ...
        // DONE: precisa bloquear ate que tenha algo a consumir
        // while(p == 0);
        // P = wait
        P(full);
        ...
        // 
        // DONE: precisa garantir exclusão mutua ao acessar o buffer
        //
        P(mutex);
        ...
        // V = signal
        //
        // DONE: saindo da seção critica
        //
        V(mutex);
        
        //
        // DONE: liberando o recurso
        //
        V(empty);
...
void * producer(void * id){
    ...
    //
    // DONE: precisa bloquear até que tenha posicao disponível no buffer
    //
    // while(p == N_BUFFER); 
    // P = wait
    P(empty);
    ...
    // 
    // DONE: precisa garantir o acesso exclusivo ao buffer
    //
    P(mutex);
    ...
    // V = signal
    // 
    // DONE: liberar o acesso ao buffer
    //
    V(mutex);
    
    //
    // DONE: liberar para o consumidor acessar o buffer
    //
    V(full);
